...
do
    ...
    # ------------------------------
    _CursesStep debut CCSI02 "\033[34m$Version\033[m \033[5;46m Running \033[m"
    ...
    if [ $NbPaquet -ge 3 ]
    then
	_CursesStep fin CCSI02 "\033[34m$Version\033[m \033[22;32mFound in workspace\033[m"
	echo   ""
	printf "\033[34mPackage already built and available in workspace directory ...\033[m\n"
	echo   ""

	_CursesStep debut CCSI04 "\033[34m$Version\033[m \033[5;46m Running \033[m"
	$KRN_sudo dpkg -i --refuse-downgrade $KRN_WORKSPACE/linux-*${PackageVersion}*.deb
	_CursesStep fin CCSI04 "\033[34m$Version\033[m \033[22;32mInstalled\033[m"
	continue
    fi
    _CursesStep fin CCSI02 "\033[34m$Version\033[m \033[22;32mNo package available\033[m"
     
    # Telechargement des paquets
    # --------------------------
    _CursesStep debut CCSI03 "\033[34m$Version\033[m \033[5;46m Running \033[m"
    ...
    _CursesStep fin CCSI03 "\033[22;32m$(basename $KRN_WORKSPACE/linux-${Version}.tar.??)\033[m"
	...
	_CursesStep fin CCSI04 "\033[34m$Version\033[m \033[31mFAILED\033[m"
	return 1
    fi
done
