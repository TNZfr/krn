...
then
    echo   ""
    printf " \033[30;42m KRN v7.2 \033[m : Kernel management tool\n"
    echo   ""
    ...
    echo  "Sign           (SK): Sign installed kernel (DEBIAN only, beta for ARCH and GENTOO)"
    echo  "VerifyKernel   (VK): Verify installed kernel and module signatures"
    echo  "InstallSign    (IS): Install and sign selected kernel (DEBIAN, beta for ARCH and GENTOO)"
    echo  ""
    ...
    echo  "CompilSignInstall (CCSI): Get sources, compile, sign and install kernel (DEBIAN, beta for ARCH and GENTOO)"
    echo  ""
